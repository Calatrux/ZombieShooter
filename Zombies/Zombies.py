...
class Game:
    ...
    def advance_wave(self):
        if self.wave_timer.update(): # if cooldown is over, advance wave
            ...
            if self.zombie_spawner.zombie_cooldown >= 0.25: # if cooldown is greater than 0.25, decrease it by 0.1, stops game from becoming impossible
